    ...
    <section className="py-16 bg-slate-50 dark:bg-[#2C2D33]">
      ...
      <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 px-6 lg:px-12">
        {blogs.map((blog) => (
          <div
            key={blog.id}
            className="relative dark:bg-[#4b4f5c] hover:scale-105 bg-slate-50 rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-transform duration-300"
          >
            <img
              src={blog.image}
              alt={blog.title}
            ...
            <div className="p-6">
              <p className="text-orange-500 font-semibold">{blog.category}</p>
