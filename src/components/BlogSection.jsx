...
const blogs = [
	{
		...
		date: '23 Dec',
		image: '/assets/blogs/blog1.jpg', // Replace with your actual image path
	},
	{
		id: 2,
		category: 'Branding',
		...
		date: '23 Dec',
		image: '/assets/blogs/blog2.jpg', // Replace with your actual image path
	},
	{
		id: 3,
		...
		date: '23 Dec',
		image: '/assets/blogs/blog3.jpg', // Replace with your actual image path
	},
];
			...
			<div className='mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 px-6 lg:px-12'>
				{blogs.map(blog => (
					...
					>
						...
						/>
						<div className='absolute top-4 left-4 bg-green-500 text-white text-center text-sm px-3 py-1 rounded-md shadow-md'>
							<p>
								{
									blog.date.split(
										' '
