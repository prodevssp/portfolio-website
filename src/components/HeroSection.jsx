    ...
    <section className="h-screen flex items-center justify-center bg-no-repeat bg-cover bg-center bg-[url('/assets/backgrounds/hero-bg.jpg')] dark:bg-[url('/assets/backgrounds/hero-bg-dark.jpg')]">
      <div className="max-w-6xl flex items-center justify-between w-full">
        <div className="flex flex-col items-start space-y-4">
          ...
          <p className="lg:text-xl xl:text-2xl text-gray-500 dark:text-white">
          ...
          <p className="text-gray-500 dark:text-white max-w-md lg:text-lg xl:text-xl">
            ...
            <div className="flex gap-3 items-center">
              <div>
                <a href={config.socials.linkedin} target="_blank">
                  <FaLinkedinIn size={25} className="dark:fill-white" />
                </a>
              </div>
              <div>
              ...
              <div>
                <a href={config.socials.mail} target="_blank">
                  <IoMdMail size={25} className="dark:fill-white" />
                </a>
              </div>
            </div>
          </div>
